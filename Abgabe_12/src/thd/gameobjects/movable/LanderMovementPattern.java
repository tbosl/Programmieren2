...
class LanderMovementPattern extends AlienInvadersRandomMovementPattern {
    ...
    protected Position startPosition(Position... referencePositions) {
        ...
        return generateRandomPositionWithDistanceToSpaceship(marginToSideBorders, GamePlayManager.ABSOLUTE_WORLD_LENGTH - marginToSideBorders, referencePositions[0], 350);
    }
